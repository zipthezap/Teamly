      ...
      <div className="w-full px-2 sm:px-4">
        <div className="flex items-center justify-between h-16 w-full">
          ...
          {user && (
            <div className="hidden lg:flex gap-1 flex-1 justify-center">
              ...
              <AppNavItem to="/sessions" label={t('common.sessions')} svg={<svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /></svg>} />
              <AppNavItem to="/leagues" label={t('common.leagues')} svg={<svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>} />
        ...
        {user && mobileMenuOpen && (
          ...
          >
            ...
            <AppNavItem to="/sessions" label={t('common.sessions')} onClick={closeMobileMenu} svg={<svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /></svg>} />
            <AppNavItem to="/leagues" label={t('common.leagues')} onClick={closeMobileMenu} svg={<svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>} />
