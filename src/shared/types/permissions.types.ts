...
export enum Permission {
  ...
  GROUP_REVOKE_INVITES = 'group:revoke_invites',
  GROUP_VIEW_INVITE_ANALYTICS = 'group:view_invite_analytics',
  ...
  EVENT_INVITE_MEMBERS = 'event:invite_members',
  EVENT_REVOKE_INVITES = 'event:revoke_invites',
  EVENT_VIEW_INVITE_ANALYTICS = 'event:view_invite_analytics',
