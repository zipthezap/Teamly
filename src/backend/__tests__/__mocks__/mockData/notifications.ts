...
export const mockTournamentNotifications = [
  ...
  },
  {
    ...
    params: { tournamentName: 'Winter Cup' },
    read: true,
  ...
  },
  {
    ...
    params: { tournamentName: 'Summer Championship', matchId: 'match-1' },
    read: false,
  ...
  },
  {
    ...
    userId: 'user-1',
    type: 'announcement',
    params: { tournamentName: 'Summer Championship', title: 'Check-in opens at 8AM' },
    read: false,
