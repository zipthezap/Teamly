...
const getUserName = (req: Request): string => req.header('x-user-name') || 'Teamly User';
...
export const sendTeamInvitation = async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('Failed to send team invitation email', 'TournamentService', {
      tournamentId: id,
      teamId,
      inviteeEmail,
      error: emailError,
  ...
  try {
    ...
    logger.error('Failed to create in-app notification for team invitation', 'TournamentService', {
      tournamentId: id,
      teamId,
      inviteeEmail,
      error: notifError,
  ...
  logger.info('Team invitation sent', 'TournamentService', {
    tournamentId: id,
    teamId,
    inviteeEmail,
    userId,
...
export const acceptTeamInvitation = async (req: Request, res: Response) => {
  ...
  logger.info('Team invitation accepted', 'TournamentService', {
  ...
  try {
    ...
    logger.error('Failed to notify captain about accepted invitation', 'TournamentService', {
      error: notifError,
      invitationId: invitation.id,
    });
  }
...
export const declineTeamInvitation = async (req: Request, res: Response) => {
  ...
  logger.info('Team invitation declined', 'TournamentService', {
    invitationId: invitation.id,
    teamId: invitation.teamId,
    userId,
  });
  ...
  try {
    ...
    logger.error('Failed to notify captain about declined invitation', 'TournamentService', {
      error: notifError,
      invitationId: invitation.id,
    });
  }
...
export const cancelTeamInvitation = async (req: Request, res: Response) => {
  ...
  logger.info('Team invitation cancelled', 'TournamentService', {
    tournamentId: id,
    teamId,
    invitationId,
    userId,
