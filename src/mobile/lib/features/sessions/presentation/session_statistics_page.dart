...
class SessionStatisticsPage extends ConsumerWidget {
  const SessionStatisticsPage({super.key});
        ...
        data: (stats) => RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _SmallStat(
                            label: 'Total Players',
                            value:
                                '${stats.createdSessionsStats.totalParticipants}'),
                        _SmallStat(
                            label: 'Avg Players',
                            value: stats
                                .createdSessionsStats.avgParticipantsPerEvent
                                .toStringAsFixed(1)),
                      ],
                    ),
                  ),
              ...
              if (stats.sessionTypeBreakdown.isNotEmpty) ...[
                const SizedBox(height: 24),
                Text('By Sport Type', style: theme.textTheme.titleMedium),
                const SizedBox(height: 12),
                Card(
                  child: Column(
                    children: stats.sessionTypeBreakdown.entries
                        .toList()
                        .where((e) => e.value > 0)
                        .map((entry) {
                      final total = stats.totalSessionsJoined > 0
                          ? stats.totalSessionsJoined
                          : 1;
